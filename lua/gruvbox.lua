...
Gruvbox.palette = {
  ...
  light4 = "#a89984",
  bright_red = "#ea6962", --y
  bright_green = "#a9b665", --y
  bright_yellow = "#d8a657", --y
  bright_blue = "#7daea3", --y
  bright_purple = "#d3869b", --y
  bright_aqua = "#89b482", --y
  bright_orange = "#e78a4e", --y
  neutral_red = "#d1534e", -- Same as above, but - 7 lightness on OKLCH scale
  neutral_green = "#94a04f", --y
  neutral_yellow = "#c19040", --y
  neutral_blue = "#68988e", --y
  neutral_purple = "#bc7186", --y
  neutral_aqua = "#749e6d", --y
  neutral_orange = "#cf7437", --y
  faded_red = "#e0716a", --Same as above, but - 2 Chroma
  faded_green = "#a9b572", --y
  faded_yellow = "#d0a96d", --y
  faded_blue = "#88aba3", --y
  faded_purple = "#cb8b9c", --y
  faded_aqua = "#8eb289", --y
  faded_orange = "#e08e5b", --y
  dark_red_hard = "#472322", --y
  dark_red = "#402120", --y
  dark_red_soft = "#472322", --y
  light_red_hard = "#f8e4c9", --y
  light_red = "#f9e0bb", --y
  light_red_soft = "#f7d9b9", --y
  dark_green_hard = "#3d4220", --y
  dark_green = "#34381b", --y
  dark_green_soft = "#3d4220", --y
  light_green_hard = "#e4edc8", --y
  light_green = "#e6eabc", --y
  light_green_soft = "#dfe1b4", --y
  dark_aqua_hard = "#0d3138", --USING BLUE
  dark_aqua = "#0e363e", --USING BLUE
  dark_aqua_soft = "#0f3a42", --USING BLUE
  light_aqua_hard = "#e0e9d3", --USING BLUE
  light_aqua = "#e2e6c7", --USING BLUE
  light_aqua_soft = "#dbddbf", --USING BLUE
  gray = "#928374",
}
